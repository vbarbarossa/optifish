...
# read the manually compiled list
sp_40 <- read.csv('data/mekong_top_species.csv')

# check --> 31 of 37 species have a match
sum(sp_40$binomial %in% sp_data$binomial)

sp_data <- sp_data %>% filter(binomial %in% sp_40$binomial)
# ------------------------------------------------------------------------------
